...
impl Sprite {
    pub fn new(name: String, texture: Arc<vulkano::image::ImmutableImage<vulkano::format::Format>>, pos: [f32; 2], size: [u32; 2], matrix_dims: [u32; 2]) -> Self {
    ...
    pub fn update_animation(&mut self, animation_state: [u8;2]) {
