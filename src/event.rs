...
use crate::{error::*, graphics, interface::*};
use std::time;
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        match event {
            ...
            Event::MainEventsCleared => {
                ...
                let shader = interface.graphics_context.shaders
                    [interface.graphics_context.default_shader]
                    .clone();
                ...
                print!(
                    "frame time: {:.2}ms u: {:.2}ms d: {:.2}ms p: {:.2}ms i: {:.2}ms\r",
                    frame_time,
                    update_time,
                    draw_time,
                    present_time,
